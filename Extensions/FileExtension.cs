namespace ERP_System_Project.Extensions
{
    ...
    {
        public static bool IsValidFile(this IFormFile file, List<string> validExtensions, long maximumSize)
        {
            ...
            if (file.Length > maximumSize)
                throw new Exception($"File size exceeds the maximum limit of {maximumSize}.");
